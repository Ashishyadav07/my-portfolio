  ...
  projects: [
    {
      ...
      longDescription: "A modern full-stack e-commerce platform featuring product browsing, category filtering, shopping cart, user authentication, secure checkout flow, and an intuitive shopping experience.",
      tags: ["React", "Node.js", "Express.js", "MongoDB", "Tailwind CSS", "JWT Authentication"],
    ...
    },
    {
      ...
      longDescription: "A modern food delivery platform where users can browse restaurants, explore menus, add items to the cart, place orders, and enjoy a responsive, user-friendly ordering experience.",
    ...
    },
    {
      ...
      longDescription: "A professional digital marketing agency website designed and developed using WordPress and Elementor with a strong focus on branding, responsiveness, SEO, performance, and modern UI/UX.",
      tags: ["WordPress", "Elementor", "PHP", "Custom CSS"],
